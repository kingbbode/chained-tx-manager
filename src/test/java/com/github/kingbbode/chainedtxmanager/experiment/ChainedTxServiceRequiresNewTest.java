...
import com.github.kingbbode.chainedtxmanager.data.b.BDataRequiresNewService;
...
@SpringBootTest
@Import(ChainedTxServiceRequiresNewTest.TestConfig.class)
class ChainedTxServiceRequiresNewTest {

	static class TestConfig {
		@Bean
		public ChainedTxService chainedTxService(
			ADataService aDataService,
			BDataRequiresNewService bDataRequiresNewService
		) {
			return new ChainedTxService(aDataService, bDataRequiresNewService);
		}
	}
